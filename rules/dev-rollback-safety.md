...
- Breaking changes follow expand-contract: add the new path, migrate consumers, then remove the old - sequenced in the spec plan's impact notes (`dev-create-spec`).
