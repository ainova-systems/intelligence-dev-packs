...
- pr_success_factors: verified, reviewed   <!-- ai:* factors a PR must carry fresh at head besides ai:completed; the pack writes verified + reviewed, add any an external agent, worker or pipeline applies; none = state label only -->
