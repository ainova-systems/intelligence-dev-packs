...
4. Drain unacked PR feedback first (when a PR exists): `gh pr checks <pr>` + `gh pr view <pr> --json reviews,comments`, then `git-complete-pr`. Red lights before new work.
